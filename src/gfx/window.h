...
class Window {
 public:
  ...
  // Returns whether the is instantiated. If an error occurred while creating
  // the SDL_Window, instantiated will be false, so we can use this to ensure
  // the Window is valid before entering the game loop.

...
OverState::OverState()
    : title_{ &title_texture_, 0, 60 - title_texture_.get_height() },
      play_prompt_{ &play_texture_, 0, 80 + play_texture_.get_height() },
      quit_prompt_ { &quit_texture_, 0, 90 + quit_texture_.get_height() } {
  valid();
